angular.module('fService', [])
	...
	.factory('cifrarAES', [function(){
		return function convertir(cadena){
			var cadena = cadena;
            ...
            var _keyBase64 = function (cadena) {
                var wordArray   = null;
                wordArray       = CryptoJS.enc.Utf8.parse(_repeatCadena(cadena, 16));
                return CryptoJS.enc.Base64.stringify(wordArray);
            }

            var userSesion = 10020;
            var keyValue = null;
            var key = null;
            var iv = null;

            keyValue = _keyBase64(userSesion.toString());
